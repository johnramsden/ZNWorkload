...
#define PROFILING_METRICS 9 // Keep in sync with enum, zn_profiler_metric_names, and zn_profiler_metric_types
enum zn_profiler_tag {
    ...
    ZN_PROFILER_METRIC_WRITE_THROUGHPUT = 6,
    ZN_PROFILER_METRIC_READ_THROUGHPUT = 7,
